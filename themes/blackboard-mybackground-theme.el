...
;;; Code
(deftheme blackboard-mybackground
  "Based on Color theme by JD Huntington, which based off the TextMate Blackboard theme, created 2008-11-27")

(custom-theme-set-faces
 `blackboard-mybackground
 `(default ((t (:background "#2d3743" :foreground "#F8F8F8" ))))
 `(bold ((t (:bold t))))
 `(bold-italic ((t (:bold t))))
 `(border-glyph ((t (nil))))
 `(buffers-tab ((t (:background "#00FFFF" :foreground "#F8F8F8"))))
...
(provide-theme 'blackboard-mybackground)
